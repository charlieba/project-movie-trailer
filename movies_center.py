...
deadpool = media.Movie("Deadpool",
                    ...
                    "experiment that leaves him with accelerated healing powers, adopting the alter "
                    "ego Deadpool.",
                    "http://cdn.foxplay.com/sites/common/objects/img/movies/resized/320x480/218170_poster_600_888_20161028050253.jpg",
...
bridge_of_spies = media.Movie("Bridge of Spies",
                    "La historia de James Donovan, un abogado de Brooklyn que termina en medio de la "
                    "Guerra Fria cuando la CIA lo envia con la tarea casi imposible de negociar la "
                    "liberacion de un piloto estadunidense capturado.",
                    "http://cdn.foxplay.com/sites/common/objects/img/movies/resized/320x480/218156_poster_600_888_20160730050431.jpg",
...
# Hitman movie
hitman = media.Movie("HITMAN",
                    "Producto de un experimento genetico que le dio inteligencia superior y habilidades "
                    "sobrehumanas, el agente 47 se convirtio en una perfecta maquina de matar. En equipo "
                    "con una joven misteriosa, descubrira los secretos de su origen.",
                    "http://cdn.foxplay.com/sites/common/objects/img/movies/resized/320x480/218155_poster_600_888_20160628051033.jpg",
...
movies = [deadpool, wolverine, xmen, revenant, bridge_of_spies, fantastic_four, wwz, mission_impossible, shrek, casper]  # Push each movie object into an array
fresh_tomatoes_with_tooltip.open_movies_page(movies)  # Generating the movie trailers page .html
print(media.Movie.__doc__)  # Print in console the documentation of the class Movie
